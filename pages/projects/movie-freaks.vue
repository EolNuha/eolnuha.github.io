<template>
  <div>
    <Header smallText="Project" largeText="Movie Freaks" />
    <div class="container">
      <Carosuel
        :imgs="[
          {
      ...
      <div class="my-8">
        <p>
          Movie Freaks is a web-based movie streaming application that was
          expertly crafted using Python's renowned Django framework, along with
          other essential technologies including JavaScript, JQuery, HTML, CSS,
          and Bootstrap. The application boasts an intuitive and user-friendly
          interface that is both sleek and modern. Its mobile-first design
          allows for seamless access and optimal viewing across a range of
          devices, while its thoughtful features cater to the unique needs of
          every user. All in all, Movie Freaks promises a streamlined and
          hassle-free movie streaming experience that you won't want to miss.
        </p>
        <h3 class="font-bold my-3">Technologies used:</h3>
        <div class="flex gap-[5px] items-center flex-wrap">
          <span class="pillar">Python</span>
          <span class="pillar">Django</span>
          <span class="pillar">JavaScript</span>
          <span class="pillar">JQuery</span>
        ...
        <div class="flex gap-[5px] items-center flex-wrap">
          ...
          <a href="https://github.com/EolNuha/moviefreaks-django">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
              class="w-8 h-8"
