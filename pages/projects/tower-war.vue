<template>
  <div>
    <Header smallText="Project" largeText="Tower War Game" />
    <div class="container">
      <Carosuel
        :imgs="[
          {
            src: require('~/assets/images/projects/tower-1.png'),
            alt: 'Tower War game',
          },
          {
            src: require('~/assets/images/projects/tower-3.png'),
            alt: 'Tower War game',
          },
          {
            src: require('~/assets/images/projects/tower-4.png'),
            alt: 'Tower War game',
          },
          {
            src: require('~/assets/images/projects/tower-5.png'),
            alt: 'Tower War game',
          },
          {
            src: require('~/assets/images/projects/tower-2.png'),
            alt: 'Tower War game',
          },
        ]"
      />
      <div class="my-8">
        <p>
          The Tower War Game is a captivating desktop application built on the
          Python programming language and the Pygame framework. It presents a
          strategic and immersive experience where players place and
          strategically maneuver towers in a battle against formidable monsters.
          With varying levels of difficulty to choose from, the game features a
          total of sixty engaging levels - twenty for each difficulty setting.
          Should the player successfully conquer all sixty levels, they will
          emerge as the ultimate victor of this epic tower defense game.
        </p>
        ...
        <div class="flex gap-[5px] items-center flex-wrap">
          ...
          <a
            href="https://github.com/EolNuha/Python-Games/tree/master/Tower-War-Game"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
